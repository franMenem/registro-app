...
import { formatCurrency, validateCUIT, formatDate } from '@/utils/format';
...
const FormularioCaja: React.FC = () => {
  ...
  const { data: movimientos = [] } = useQuery({
    queryKey: ['movimientos', { tipo: 'CAJA', limit: 5 }],
    queryFn: () => movimientosApi.getAll({ tipo: 'CAJA', limit: 5 }),
  });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <MetricCard
            ...
            value={formatCurrency(stats?.total_caja_hoy || 0)}
