-- ============================================================================
-- FIX: Parentesis en key DEPOSITO_X en procesar_caja_diario y procesar_rentas_diario
-- Fecha: 2026-02-06
-- Bug: p_values->>'DEPOSITO_' || v_i se evaluaba como (p_values->>'DEPOSITO_') || v_i
--       Solucion: p_values->>('DEPOSITO_' || v_i)
-- ============================================================================

-- Solo re-ejecutar las dos funciones con el fix.
-- La tabla gastos_deposito ya existe, no hace falta recrearla.

-- ============================================================================
-- 1. FIX procesar_caja_diario
-- ============================================================================
